...
<div class="food-gallery">
  ...
  <button class="food-gallery__item" type="button" data-food-image="/images/food/IMG_0673_edited.png" data-food-caption="Roasted cabbage with chimichurri" aria-label="Enlarge roasted cabbage dish">
...
<dialog class="food-lightbox" id="food-lightbox" aria-label="Enlarged food photograph" aria-describedby="food-lightbox-caption">
  ...
  <p class="food-lightbox__caption" id="food-lightbox-caption"></p>
</dialog>
...
<script>
  (() => {
    ...
    const caption = dialog.querySelector('.food-lightbox__caption');
    ...
    document.querySelectorAll('[data-food-image]').forEach((button) => {
      button.addEventListener('click', () => {
        ...
        caption.textContent = button.dataset.foodCaption;
        dialog.showModal();
      });
    });
